"""C11, full-graph capture for serving frameworks (paper 5.6).
    ...
    PYTHONPATH=$PWD python -m paper_eval.run_fullgraph            # all rows
    PYTHONPATH=$PWD python -m paper_eval.run_fullgraph t5-small   # some rows
...
def _run(key, mode):
    ...
    try:
        ...
        shutil.copy(os.path.join(repo, "paper_eval", "entry.py"),
