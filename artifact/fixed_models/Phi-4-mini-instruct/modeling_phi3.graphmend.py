...
class Phi3MLP(nn.Module):
    ...
    def forward(self: Any, hidden_states: torch.FloatTensor) -> torch.FloatTensor:
...
def eager_attention_forward(module: nn.Module, query: torch.Tensor, key: torch.Tensor, value: torch.Tensor, attention_mask: Optional[torch.Tensor], scaling: float, dropout: float=0.0, **kwargs: Any) -> object:
...
def apply_rotary_pos_emb(q: Any, k: Any, cos: Any, sin: Any, position_ids: Any=None, unsqueeze_dim: Any=1) -> object:
...
class Phi3Attention(nn.Module):
    ...
    def __init__(self: Any, config: Phi3Config, layer_idx: Optional[int]=None) -> object:
        super().__init__()
        self.config = config
    ...
    def forward(self: Any, hidden_states: torch.Tensor, position_embeddings: Tuple[torch.Tensor, torch.Tensor], attention_mask: Optional[torch.Tensor], past_key_value: Optional[Cache]=None, cache_position: Optional[torch.LongTensor]=None, **kwargs: Unpack[FlashAttentionKwargs]) -> Tuple[torch.Tensor, Optional[torch.Tensor], Optional[Tuple[torch.Tensor]]]:
        ...
        if self.config._attn_implementation != 'eager':
            if self.config._attn_implementation == 'sdpa' and kwargs.get('output_attentions', False):
                __jac_log_emit__(_gm_log_slot_0, ('`torch.nn.functional.scaled_dot_product_attention` does not support `output_attentions=True`. Falling back to "\n                    \'eager attention. This warning can be removed using the argument `attn_implementation="eager"` when loading the model.',), {})
            else:
...
class Phi3RMSNorm(nn.Module):
    ...
    def extra_repr(self: Any) -> object:
        return f'{tuple(self.weight.shape)}, eps={self.variance_epsilon}'

class Phi3DecoderLayer(GradientCheckpointingLayer):

    def __init__(self: Any, config: Phi3Config, layer_idx: int) -> object:
        super().__init__()
...
class Phi3RotaryEmbedding(nn.Module):
    ...
    def __init__(self: Any, config: Phi3Config, device: Any=None) -> object:
        super().__init__()
    ...
    @torch.no_grad()
    @dynamic_rope_update
    def forward(self: Any, x: Any, position_ids: Any) -> object:
...
class Phi3Model(Phi3PreTrainedModel):
    ...
    def __init__(self: Any, config: Phi3Config) -> object:
    ...
    def forward(self: Any, input_ids: Optional[torch.LongTensor]=None, attention_mask: Optional[torch.Tensor]=None, position_ids: Optional[torch.LongTensor]=None, past_key_values: Optional[Cache]=None, inputs_embeds: Optional[torch.FloatTensor]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, cache_position: Optional[torch.LongTensor]=None, **flash_attn_kwargs: Unpack[FlashAttentionKwargs]) -> BaseModelOutputWithPast:
        ...
        for decoder_layer in self.layers[:self.config.num_hidden_layers]:
            ...
            layer_outputs = decoder_layer(hidden_states, attention_mask=causal_mask, position_ids=position_ids, past_key_value=past_key_values, output_attentions=output_attentions, use_cache=use_cache, cache_position=cache_position, position_embeddings=position_embeddings, **flash_attn_kwargs)
    ...
    @staticmethod
    def _prepare_4d_causal_attention_mask_with_cache_position(attention_mask: torch.Tensor, sequence_length: int, target_length: int, dtype: torch.dtype, cache_position: torch.Tensor, batch_size: int, config: Phi3Config, past_key_values: Cache) -> object:
        """
...
I'm not conscious, but I can talk to you."
    ...
    def prepare_inputs_for_generation(self: Any, input_ids: Any, past_key_values: Any=None, attention_mask: Any=None, inputs_embeds: Any=None, cache_position: Any=None, position_ids: Any=None, use_cache: Any=True, logits_to_keep: Any=None, **kwargs: Any) -> object:
...
class Phi3ForSequenceClassification(Phi3PreTrainedModel):
    ...
    @can_return_tuple
    @auto_docstring
    def forward(self: Any, input_ids: Optional[torch.LongTensor]=None, attention_mask: Optional[torch.Tensor]=None, position_ids: Optional[torch.LongTensor]=None, past_key_values: Optional[Cache]=None, inputs_embeds: Optional[torch.FloatTensor]=None, labels: Optional[torch.LongTensor]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None) -> SequenceClassifierOutputWithPast:
        '''r"""
        ...
        """'''
        transformer_outputs: BaseModelOutputWithPast = self.model(input_ids, attention_mask=attention_mask, position_ids=position_ids, past_key_values=past_key_values, inputs_embeds=inputs_embeds, use_cache=use_cache, output_attentions=output_attentions, output_hidden_states=output_hidden_states)
        ...
        if self.config.pad_token_id is None:
            ...
            last_non_pad_token = -1
            __jac_log_emit__(_gm_log_slot_2, (f'{self.__class__.__name__} will not detect padding tokens in `inputs_embeds`. Results may be "\n                "unexpected if using padding tokens in conjunction with `inputs_embeds.`"',), {})
...
class Phi3ForTokenClassification(Phi3PreTrainedModel):
    ...
    @can_return_tuple
    @auto_docstring
    def forward(self: Any, input_ids: Optional[torch.LongTensor]=None, attention_mask: Optional[torch.Tensor]=None, position_ids: Optional[torch.LongTensor]=None, past_key_values: Optional[Cache]=None, inputs_embeds: Optional[torch.FloatTensor]=None, labels: Optional[torch.LongTensor]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None) -> TokenClassifierOutput:
        '''r"""
        labels (`torch.LongTensor` of shape `(batch_size,)`, *optional*):
            Labels for computing the sequence classification/regression loss. Indices should be in `[0, ...,
            config.num_labels - 1]`. If `config.num_labels == 1` a regression loss is computed (Mean-Square loss), If
            `config.num_labels > 1` a classification loss is computed (Cross-Entropy).
        """'''
        outputs: BaseModelOutputWithPast = self.model(input_ids, attention_mask=attention_mask, position_ids=position_ids, past_key_values=past_key_values, inputs_embeds=inputs_embeds, use_cache=use_cache, output_attentions=output_attentions, output_hidden_states=output_hidden_states)
