...
class Inception3(nn.Module):
    ...
    def __init__(self: Any, num_classes: int=1000, aux_logits: bool=True, transform_input: bool=False, inception_blocks: Optional[List[Callable[..., nn.Module]]]=None, init_weights: Optional[bool]=None, dropout: float=0.5) -> None:
        super().__init__()
    ...
    def _transform_input(self: Any, x: Tensor) -> Tensor:
    ...
    def _forward(self: Any, x: Tensor) -> Tuple[Tensor, Optional[Tensor]]:
    ...
    @torch.jit.unused
    def eager_outputs(self: Any, x: Tensor, aux: Optional[Tensor]) -> InceptionOutputs:
        if self.training and self.aux_logits:
            return InceptionOutputs(x, aux)
        else:
            return x

    def forward(self: Any, x: Tensor) -> InceptionOutputs:
        x = self._transform_input(x)
        x, aux = self._forward(x)
        aux_defined = self.training and self.aux_logits
        if torch.jit.is_scripting():
            if not aux_defined:
                __jac_log_emit__(_gm_log_slot_0, ('Scripted Inception3 always returns Inception3 Tuple',), {})
            return InceptionOutputs(x, aux)
        else:
...
class InceptionA(nn.Module):
    ...
    def __init__(self: Any, in_channels: int, pool_features: int, conv_block: Optional[Callable[..., nn.Module]]=None) -> None:
        super().__init__()
    ...
    def _forward(self: Any, x: Tensor) -> List[Tensor]:
...
class InceptionB(nn.Module):
    ...
    def __init__(self: Any, in_channels: int, conv_block: Optional[Callable[..., nn.Module]]=None) -> None:
        super().__init__()
        if conv_block is None:
            conv_block = BasicConv2d
...
class InceptionC(nn.Module):
    ...
    def __init__(self: Any, in_channels: int, channels_7x7: int, conv_block: Optional[Callable[..., nn.Module]]=None) -> None:
        super().__init__()
        if conv_block is None:
            conv_block = BasicConv2d
...
class InceptionAux(nn.Module):
    ...
    def __init__(self: Any, in_channels: int, num_classes: int, conv_block: Optional[Callable[..., nn.Module]]=None) -> None:
        super().__init__()
        if conv_block is None:
            conv_block = BasicConv2d
...
class BasicConv2d(nn.Module):
    ...
    def __init__(self: Any, in_channels: int, out_channels: int, **kwargs: Any) -> None:
        super().__init__()
