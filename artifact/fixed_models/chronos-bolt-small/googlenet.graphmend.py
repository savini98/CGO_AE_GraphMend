...
class QuantizableBasicConv2d(BasicConv2d):
    ...
    def fuse_model(self: Any, is_qat: Optional[bool]=None) -> None:
...
class QuantizableGoogLeNet(GoogLeNet):
    ...
    def forward(self: Any, x: Tensor) -> GoogLeNetOutputs:
        ...
        if torch.jit.is_scripting():
            if not aux_defined:
                __jac_log_emit__(_gm_log_slot_0, ('Scripted QuantizableGoogleNet always returns GoogleNetOutputs Tuple',), {})
