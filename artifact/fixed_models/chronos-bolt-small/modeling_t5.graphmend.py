...
from ...utils import DUMMY_INPUTS, DUMMY_MASK, add_start_docstrings, auto_docstring, is_torch_flex_attn_available, is_torch_fx_proxy, is_torchdynamo_compiling, logging
...
def load_tf_weights_in_t5(model: Any, config: Any, tf_checkpoint_path: Any) -> object:
...
class T5LayerNorm(nn.Module):
    ...
    def __init__(self: Any, hidden_size: Any, eps: Any=1e-06) -> object:
        """
...
class T5DenseActDense(nn.Module):
    ...
    def __init__(self: Any, config: T5Config) -> object:
        super().__init__()
...
class T5Attention(nn.Module):
    ...
    def __init__(self: Any, config: T5Config, has_relative_attention_bias: Any=False, layer_idx: Optional[int]=None) -> object:
        super().__init__()
    ...
    @staticmethod
    def _relative_position_bucket(relative_position: Any, bidirectional: Any=True, num_buckets: Any=32, max_distance: Any=128) -> object:
        """
    ...
    def compute_bias(self: Any, query_length: Any, key_length: Any, device: Any=None, cache_position: Any=None) -> object:
    ...
    def forward(self: Any, hidden_states: Any, mask: Any=None, key_value_states: Any=None, position_bias: Any=None, past_key_value: Any=None, layer_head_mask: Any=None, query_length: Any=None, use_cache: Any=False, output_attentions: Any=False, cache_position: Any=None) -> object:
        """
...
class T5LayerSelfAttention(nn.Module):
    ...
    def __init__(self: Any, config: Any, has_relative_attention_bias: Any=False, layer_idx: Optional[int]=None) -> object:
        super().__init__()
        self.SelfAttention = T5Attention(config, has_relative_attention_bias=has_relative_attention_bias, layer_idx=layer_idx)
        self.layer_norm = T5LayerNorm(config.d_model, eps=config.layer_norm_epsilon)
        self.dropout = nn.Dropout(config.dropout_rate)

    def forward(self: Any, hidden_states: Any, attention_mask: Any=None, position_bias: Any=None, layer_head_mask: Any=None, past_key_value: Any=None, use_cache: Any=False, output_attentions: Any=False, cache_position: Any=None) -> object:
        normed_hidden_states = self.layer_norm(hidden_states)
        attention_output = self.SelfAttention(normed_hidden_states, mask=attention_mask, position_bias=position_bias, layer_head_mask=layer_head_mask, past_key_value=past_key_value, use_cache=use_cache, output_attentions=output_attentions, cache_position=cache_position)
...
class T5LayerCrossAttention(nn.Module):
    ...
    def __init__(self: Any, config: Any, layer_idx: Optional[int]=None) -> object:
        super().__init__()
        self.EncDecAttention = T5Attention(config, has_relative_attention_bias=False, layer_idx=layer_idx)
        self.layer_norm = T5LayerNorm(config.d_model, eps=config.layer_norm_epsilon)
        self.dropout = nn.Dropout(config.dropout_rate)

    def forward(self: Any, hidden_states: Any, key_value_states: Any, attention_mask: Any=None, position_bias: Any=None, layer_head_mask: Any=None, past_key_value: Any=None, use_cache: Any=False, query_length: Any=None, output_attentions: Any=False, cache_position: Any=None) -> object:
        normed_hidden_states = self.layer_norm(hidden_states)
        attention_output = self.EncDecAttention(normed_hidden_states, mask=attention_mask, key_value_states=key_value_states, position_bias=position_bias, layer_head_mask=layer_head_mask, past_key_value=past_key_value, use_cache=use_cache, query_length=query_length, output_attentions=output_attentions, cache_position=cache_position)
...
class T5Block(nn.Module):
    ...
    def forward(self: Any, hidden_states: Any, attention_mask: Any=None, position_bias: Any=None, encoder_hidden_states: Any=None, encoder_attention_mask: Any=None, encoder_decoder_position_bias: Any=None, layer_head_mask: Any=None, cross_attn_layer_head_mask: Any=None, past_key_value: Any=None, use_cache: Any=False, output_attentions: Any=False, return_dict: Any=True, cache_position: Any=None) -> object:
        self_attention_outputs = self.layer[0](hidden_states, attention_mask=attention_mask, position_bias=position_bias, layer_head_mask=layer_head_mask, past_key_value=past_key_value, use_cache=use_cache, output_attentions=output_attentions, cache_position=cache_position)
...
class T5PreTrainedModel(PreTrainedModel):
    ...
    def _shift_right(self: Any, input_ids: Any) -> object:
        decoder_start_token_id = self.config.decoder_start_token_id
        pad_token_id = self.config.pad_token_id
        if decoder_start_token_id is None:
            raise ValueError('self.model.config.decoder_start_token_id has to be defined. In T5 it is usually set to the pad_token_id. "\n                "See T5 docs for more information.')
...
class T5Stack(T5PreTrainedModel):
    ...
    def __init__(self: Any, config: Any, embed_tokens: Any=None) -> object:
        super().__init__(config)
        self.embed_tokens = embed_tokens
        self.is_decoder = config.is_decoder
        self.block = nn.ModuleList([T5Block(config, has_relative_attention_bias=bool(i == 0), layer_idx=i) for i in range(config.num_layers)])
    ...
    def parallelize(self: Any, device_map: Any=None) -> object:
        warnings.warn('`T5Stack.parallelize` is deprecated and will be removed in v5 of Transformers, you should load your model"\n            " with `device_map=\'balanced\'` in the call to `from_pretrained`. You can also provide your own"\n            " `device_map` but it needs to be a dictionary module_name to device, so for instance {\'block.0\': 0,"\n            " \'block.1\': 1, ...}', FutureWarning)
    ...
    def deparallelize(self: Any) -> object:
    ...
    def forward(self: Any, input_ids: Any=None, attention_mask: Any=None, encoder_hidden_states: Any=None, encoder_attention_mask: Any=None, inputs_embeds: Any=None, head_mask: Any=None, cross_attn_head_mask: Any=None, past_key_values: Any=None, use_cache: Any=None, output_attentions: Any=None, output_hidden_states: Any=None, return_dict: Any=None, cache_position: Any=None) -> object:
        ...
        if self.is_decoder and (use_cache or past_key_values is not None):
            if isinstance(past_key_values, Cache) and (not isinstance(past_key_values, EncoderDecoderCache)):
                ...
                __jac_log_emit__(_gm_log_slot_1, ('Passing a tuple of `past_key_values` is deprecated and will be removed in Transformers v4.48.0. "\n                    "You should pass an instance of `EncoderDecoderCache` instead, e.g. "\n                    "`past_key_values=EncoderDecoderCache.from_legacy_cache(past_key_values)`.',), {})
                past_key_values = EncoderDecoderCache.from_legacy_cache(past_key_values)
        ...
        for i, layer_module in enumerate(self.block):
            ...
            if self.gradient_checkpointing and self.training:
                layer_outputs = self._gradient_checkpointing_func(layer_module.forward, hidden_states, causal_mask, position_bias, encoder_hidden_states, encoder_extended_attention_mask, encoder_decoder_position_bias, layer_head_mask, cross_attn_layer_head_mask, None, use_cache, output_attentions, return_dict, cache_position)
            else:
        ...
        if not return_dict:
            return tuple((v for v in [hidden_states, next_cache, all_hidden_states, all_attentions, all_cross_attentions] if v is not None))
        return BaseModelOutputWithPastAndCrossAttentions(last_hidden_state=hidden_states, past_key_values=next_cache, hidden_states=all_hidden_states, attentions=all_attentions, cross_attentions=all_cross_attentions)
...
class T5Model(T5PreTrainedModel):
    ...
    @add_start_docstrings(PARALLELIZE_DOCSTRING)
    def parallelize(self: Any, device_map: Any=None) -> object:
        warnings.warn('`T5Model.parallelize` is deprecated and will be removed in v5 of Transformers, you should load your model"\n            " with `device_map=\'balanced\'` in the call to `from_pretrained`. You can also provide your own"\n            " `device_map` but it needs to be a dictionary module_name to device, so for instance {\'encoder.block.0\':"\n            " 0, \'encoder.block.1\': 1, ...}', FutureWarning)
    ...
    def forward(self: Any, input_ids: Optional[torch.LongTensor]=None, attention_mask: Optional[torch.FloatTensor]=None, decoder_input_ids: Optional[torch.LongTensor]=None, decoder_attention_mask: Optional[torch.BoolTensor]=None, head_mask: Optional[torch.FloatTensor]=None, decoder_head_mask: Optional[torch.FloatTensor]=None, cross_attn_head_mask: Optional[torch.Tensor]=None, encoder_outputs: Optional[Tuple[Tuple[torch.FloatTensor]]]=None, past_key_values: Optional[Tuple[Tuple[torch.FloatTensor]]]=None, inputs_embeds: Optional[torch.Tensor]=None, decoder_inputs_embeds: Optional[torch.Tensor]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None, cache_position: Optional[torch.LongTensor]=None) -> Union[Tuple[torch.FloatTensor], Seq2SeqModelOutput]:
        ...
        if head_mask is not None and decoder_head_mask is None:
            if self.config.num_layers == self.config.num_decoder_layers:
                __jac_log_emit__(_gm_log_slot_2, (__HEAD_MASK_WARNING_MSG, FutureWarning), {})
...
_gm_log_slot_2 = __jac_log_register__(warnings.warn)
...
class T5ForConditionalGeneration(T5PreTrainedModel, GenerationMixin):
    ...
    @add_start_docstrings(PARALLELIZE_DOCSTRING)
    def parallelize(self: Any, device_map: Any=None) -> object:
        warnings.warn('`T5ForConditionalGeneration.parallelize` is deprecated and will be removed in v5 of Transformers, you"\n            " should load your model with `device_map=\'balanced\'` in the call to `from_pretrained`. You can also"\n            " provide your own `device_map` but it needs to be a dictionary module_name to device, so for instance"\n            " {\'encoder.block.0\': 0, \'encoder.block.1\': 1, ...}', FutureWarning)
        self.device_map = get_device_map(len(self.encoder.block), range(torch.cuda.device_count())) if device_map is None else device_map
        assert_device_map(self.device_map, len(self.encoder.block))
        self.encoder.parallelize(self.device_map)
        self.decoder.parallelize(self.device_map)
    ...
    def forward(self: Any, input_ids: Optional[torch.LongTensor]=None, attention_mask: Optional[torch.FloatTensor]=None, decoder_input_ids: Optional[torch.LongTensor]=None, decoder_attention_mask: Optional[torch.BoolTensor]=None, head_mask: Optional[torch.FloatTensor]=None, decoder_head_mask: Optional[torch.FloatTensor]=None, cross_attn_head_mask: Optional[torch.Tensor]=None, encoder_outputs: Optional[Tuple[Tuple[torch.Tensor]]]=None, past_key_values: Optional[Tuple[Tuple[torch.Tensor]]]=None, inputs_embeds: Optional[torch.FloatTensor]=None, decoder_inputs_embeds: Optional[torch.FloatTensor]=None, labels: Optional[torch.LongTensor]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None, cache_position: Optional[torch.LongTensor]=None) -> Union[Tuple[torch.FloatTensor], Seq2SeqLMOutput]:
        ...
        if head_mask is not None and decoder_head_mask is None:
            if self.config.num_layers == self.config.num_decoder_layers:
                __jac_log_emit__(_gm_log_slot_3, (__HEAD_MASK_WARNING_MSG, FutureWarning), {})
                decoder_head_mask = head_mask
        if encoder_outputs is None:
            encoder_outputs = self.encoder(input_ids=input_ids, attention_mask=attention_mask, inputs_embeds=inputs_embeds, head_mask=head_mask, output_attentions=output_attentions, output_hidden_states=output_hidden_states, return_dict=return_dict)
        elif return_dict and (not isinstance(encoder_outputs, BaseModelOutput)):
    ...
    def _reorder_cache(self: Any, past_key_values: Any, beam_idx: Any) -> object:
...
_gm_log_slot_3 = __jac_log_register__(warnings.warn)
...
class T5EncoderModel(T5PreTrainedModel):
    ...
    @add_start_docstrings(PARALLELIZE_DOCSTRING)
    def parallelize(self: Any, device_map: Any=None) -> object:
        warnings.warn('`T5EncoderModel.parallelize` is deprecated and will be removed in v5 of Transformers, you should load"\n            " your model with `device_map=\'balanced\'` in the call to `from_pretrained`. You can also provide your own"\n            " `device_map` but it needs to be a dictionary module_name to device, so for instance {\'block.0\': 0,"\n            " \'block.1\': 1, ...}', FutureWarning)
        self.device_map = get_device_map(len(self.encoder.block), range(torch.cuda.device_count())) if device_map is None else device_map
        assert_device_map(self.device_map, len(self.encoder.block))
        self.encoder.parallelize(self.device_map)
        self.model_parallel = True
    ...
    @auto_docstring
    def forward(self: Any, input_ids: Optional[torch.LongTensor]=None, attention_mask: Optional[torch.FloatTensor]=None, head_mask: Optional[torch.FloatTensor]=None, inputs_embeds: Optional[torch.FloatTensor]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None) -> Union[Tuple[torch.FloatTensor], BaseModelOutput]:
        '''r"""
        input_ids (`torch.LongTensor` of shape `(batch_size, sequence_length)`):
            Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
            should be able to pad the inputs on both the right and the left.
...
class T5ForQuestionAnswering(T5PreTrainedModel):
    ...
    def forward(self: Any, input_ids: Optional[torch.LongTensor]=None, attention_mask: Optional[torch.FloatTensor]=None, decoder_input_ids: Optional[torch.LongTensor]=None, decoder_attention_mask: Optional[torch.BoolTensor]=None, head_mask: Optional[torch.FloatTensor]=None, decoder_head_mask: Optional[torch.FloatTensor]=None, cross_attn_head_mask: Optional[torch.Tensor]=None, encoder_outputs: Optional[Tuple[Tuple[torch.Tensor]]]=None, start_positions: Optional[torch.LongTensor]=None, end_positions: Optional[torch.LongTensor]=None, inputs_embeds: Optional[torch.FloatTensor]=None, decoder_inputs_embeds: Optional[torch.FloatTensor]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None) -> Union[Tuple[torch.FloatTensor], Seq2SeqQuestionAnsweringModelOutput]:
        ...
        if head_mask is not None and decoder_head_mask is None:
            if self.config.num_layers == self.config.num_decoder_layers:
                __jac_log_emit__(_gm_log_slot_4, (__HEAD_MASK_WARNING_MSG, FutureWarning), {})
                decoder_head_mask = head_mask
        if encoder_outputs is None:
            encoder_outputs = self.encoder(input_ids=input_ids, attention_mask=attention_mask, inputs_embeds=inputs_embeds, head_mask=head_mask, output_attentions=output_attentions, output_hidden_states=output_hidden_states, return_dict=return_dict)
        elif return_dict and (not isinstance(encoder_outputs, BaseModelOutput)):
...
_gm_log_slot_4 = __jac_log_register__(warnings.warn)
__all__ = ['T5EncoderModel', 'T5ForConditionalGeneration', 'T5Model', 'T5PreTrainedModel', 'load_tf_weights_in_t5', 'T5ForQuestionAnswering', 'T5ForSequenceClassification', 'T5ForTokenClassification']