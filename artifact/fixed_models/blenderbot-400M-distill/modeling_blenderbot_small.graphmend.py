...
class BlenderbotSmallLearnedPositionalEmbedding(nn.Embedding):
    ...
    def forward(self: Any, input_ids_shape: torch.Size, past_key_values_length: int=0, position_ids: Optional[torch.Tensor]=None) -> object:
...
class BlenderbotSmallAttention(nn.Module):
    ...
    def __init__(self: Any, embed_dim: int, num_heads: int, dropout: float=0.0, is_decoder: bool=False, bias: bool=True, is_causal: bool=False, config: Optional[BlenderbotSmallConfig]=None, layer_idx: Optional[int]=None) -> object:
        super().__init__()
...
class BlenderbotSmallEncoderLayer(nn.Module):
    ...
    def __init__(self: Any, config: BlenderbotSmallConfig, layer_idx: Optional[int]=None) -> object:
        super().__init__()
        self.embed_dim = config.d_model
        self.self_attn = BLENDERBOT_SMALL_ATTENTION_CLASSES[config._attn_implementation](embed_dim=self.embed_dim, num_heads=config.encoder_attention_heads, dropout=config.attention_dropout, config=config, layer_idx=layer_idx)
...
class BlenderbotSmallDecoderLayer(nn.Module):
    ...
    def __init__(self: Any, config: BlenderbotSmallConfig, layer_idx: Optional[int]=None) -> object:
        super().__init__()
        self.embed_dim = config.d_model
        self.self_attn = BLENDERBOT_SMALL_ATTENTION_CLASSES[config._attn_implementation](embed_dim=self.embed_dim, num_heads=config.decoder_attention_heads, dropout=config.attention_dropout, is_decoder=True, is_causal=True, config=config, layer_idx=layer_idx)
        self.dropout = config.dropout
        self.activation_fn = ACT2FN[config.activation_function]
        self.activation_dropout = config.activation_dropout
        self.self_attn_layer_norm = nn.LayerNorm(self.embed_dim)
        self.encoder_attn = BLENDERBOT_SMALL_ATTENTION_CLASSES[config._attn_implementation](self.embed_dim, config.decoder_attention_heads, dropout=config.attention_dropout, is_decoder=True, config=config, layer_idx=layer_idx)
...
class BlenderbotSmallEncoder(BlenderbotSmallPreTrainedModel):
    ...
    def __init__(self: Any, config: BlenderbotSmallConfig, embed_tokens: Optional[nn.Embedding]=None) -> object:
    ...
    def forward(self: Any, input_ids: Any=None, attention_mask: Any=None, head_mask: Any=None, inputs_embeds: Any=None, output_attentions: Any=None, output_hidden_states: Any=None, return_dict: Any=None) -> object:
        '''r"""
        Args:
...
class BlenderbotSmallDecoder(BlenderbotSmallPreTrainedModel):
    ...
    def forward(self: Any, input_ids: Any=None, attention_mask: Any=None, encoder_hidden_states: Any=None, encoder_attention_mask: Any=None, head_mask: Any=None, cross_attn_head_mask: Any=None, past_key_values: Any=None, inputs_embeds: Any=None, use_cache: Any=None, output_attentions: Any=None, output_hidden_states: Any=None, return_dict: Any=None, cache_position: Any=None) -> object:
        '''r"""
        Args:
            input_ids (`torch.LongTensor` of shape `(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
...
class BlenderbotSmallModel(BlenderbotSmallPreTrainedModel):
    ...
    def __init__(self: Any, config: BlenderbotSmallConfig) -> object:
        super().__init__(config)
...
class BlenderbotSmallForCausalLM(BlenderbotSmallPreTrainedModel, GenerationMixin):
    ...
    def _reorder_cache(past_key_values: Any, beam_idx: Any) -> object:
        ...
        return reordered_past
__all__ = ['BlenderbotSmallForCausalLM', 'BlenderbotSmallForConditionalGeneration', 'BlenderbotSmallModel', 'BlenderbotSmallPreTrainedModel']