...
if _dump:
    ...
    _marks = ('__gm_cond_', '__jac_log_emit__', '__jac_se_emit__', '__jac_tensor_eq_assert__')
    ...
    for _path, _mod in _hub.items():
        ...
        try:
            ...
            print('GMDUMP_UNPARSE_FAIL ' + _os.path.basename(str(_path)) + ' ' + type(_exc).__name__ + ': ' + str(_exc)[:120])
            continue
