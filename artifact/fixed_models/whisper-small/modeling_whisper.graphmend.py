...
def _compute_mask_indices(shape: Tuple[int, int], mask_prob: float, mask_length: int, attention_mask: Optional[torch.LongTensor]=None, min_masks: int=0) -> np.ndarray:
    ...
    def compute_num_masked_span(input_length: Any) -> object:
...
class WhisperPositionalEmbedding(nn.Embedding):
    ...
    def __init__(self: Any, num_positions: int, embedding_dim: int, padding_idx: Optional[int]=None) -> object:
        super().__init__(num_positions, embedding_dim)

    def forward(self: Any, input_ids: Any, past_key_values_length: Any=0, position_ids: Any=None) -> object:
...
class WhisperAttention(nn.Module):
    ...
    def __init__(self: Any, embed_dim: int, num_heads: int, dropout: float=0.0, is_decoder: bool=False, bias: bool=True, is_causal: bool=False, layer_idx: Optional[int]=None, config: Optional[WhisperConfig]=None) -> object:
        super().__init__()
...
class WhisperFlashAttention2(WhisperAttention):
    ...
    def forward(self: Any, hidden_states: torch.Tensor, key_value_states: Optional[torch.Tensor]=None, past_key_value: Optional[EncoderDecoderCache]=None, attention_mask: Optional[torch.Tensor]=None, layer_head_mask: Optional[torch.Tensor]=None, output_attentions: bool=False, cache_position: Optional[torch.LongTensor]=None) -> Tuple[torch.Tensor, Optional[torch.Tensor], Optional[Tuple[torch.Tensor]]]:
        if isinstance(past_key_value, StaticCache):
            raise ValueError('The `static` cache implementation is not compatible with `attn_implementation=\'flash_attention_2\'`. "\n                "Use `attn_implementation=\'sdpa\'` in the meantime, and open an issue at https://github.com/huggingface/transformers')
        is_cross_attention = key_value_states is not None
        bsz, tgt_len, _ = hidden_states.size()
        ...
        attn_output = _flash_attention_forward(query_states, key_states, value_states, causal_mask, tgt_len, dropout=self.dropout if self.training else 0.0, is_causal=self.is_causal, use_top_left_mask=self._flash_attn_uses_top_left_mask)
...
class WhisperSdpaAttention(WhisperAttention):
    ...
    def forward(self: Any, hidden_states: torch.Tensor, key_value_states: Optional[torch.Tensor]=None, past_key_value: Optional[EncoderDecoderCache]=None, attention_mask: Optional[torch.Tensor]=None, layer_head_mask: Optional[torch.Tensor]=None, output_attentions: bool=False, cache_position: Optional[torch.LongTensor]=None) -> Tuple[torch.Tensor, Optional[torch.Tensor], Optional[Tuple[torch.Tensor]]]:
        ...
        if output_attentions:
            __jac_log_emit__(_gm_log_slot_1, ('WhisperModel is using WhisperSdpaAttention, but `torch.nn.functional.scaled_dot_product_attention` does not support `output_attentions=True`. Falling back to the manual attention"\n                \' implementation, but specifying the manual implementation will be required from Transformers version v5.0.0 onwards. This warning can be removed using the argument `attn_implementation="eager"` when loading the model.',), {})
...
class WhisperEncoderLayer(nn.Module):
    ...
    def __init__(self: Any, config: WhisperConfig) -> object:
        super().__init__()
...
class WhisperDecoderLayer(nn.Module):
    ...
    def __init__(self: Any, config: WhisperConfig, layer_idx: Optional[int]=None) -> object:
        super().__init__()
        self.embed_dim = config.d_model
...
class WhisperPreTrainedModel(PreTrainedModel):
    ...
    def _get_feat_extract_output_lengths(self: Any, input_lengths: torch.LongTensor) -> object:
        """
...
class WhisperEncoder(WhisperPreTrainedModel):
    ...
    def _freeze_parameters(self: Any) -> object:
    ...
    def forward(self: Any, input_features: Any, attention_mask: Any=None, head_mask: Any=None, output_attentions: Any=None, output_hidden_states: Any=None, return_dict: Any=None) -> object:
        '''r"""
        Args:
...
class WhisperDecoder(WhisperPreTrainedModel):
    ...
    def forward(self: Any, input_ids: Any=None, attention_mask: Any=None, encoder_hidden_states: Any=None, head_mask: Any=None, cross_attn_head_mask: Any=None, past_key_values: Any=None, inputs_embeds: Any=None, position_ids: Any=None, use_cache: Any=None, output_attentions: Any=None, output_hidden_states: Any=None, return_dict: Any=None, cache_position: Any=None) -> object:
        '''r"""
        Args:
        ...
        if use_cache or past_key_values is not None:
            if isinstance(past_key_values, Cache) and (not isinstance(past_key_values, EncoderDecoderCache)):
                ...
                __jac_log_emit__(_gm_log_slot_2, ('Passing a tuple of `past_key_values` is deprecated and will be removed in Transformers v4.43.0. "\n                    "You should pass an instance of `EncoderDecoderCache` instead, e.g. "\n                    "`past_key_values=EncoderDecoderCache.from_legacy_cache(past_key_values)`.',), {})
                past_key_values = EncoderDecoderCache.from_legacy_cache(past_key_values)
        ...
        if self.gradient_checkpointing and self.training:
            if use_cache:
                __jac_log_emit__(_gm_log_slot_3, ('`use_cache = True` is incompatible with gradient checkpointing. Setting `use_cache = False`...',), {})
                use_cache = False
...
class WhisperModel(WhisperPreTrainedModel):
    ...
    def freeze_encoder(self: Any) -> object:
        """
    ...
    def _mask_input_features(self: Any, input_features: torch.FloatTensor, attention_mask: Optional[torch.LongTensor]=None) -> object:
        """
...
__all__ = ['WhisperForCausalLM', 'WhisperForConditionalGeneration', 'WhisperModel', 'WhisperPreTrainedModel', 'WhisperForAudioClassification']