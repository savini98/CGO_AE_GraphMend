...
def _v1_to_v2_weights(state_dict: Any, prefix: Any) -> object:
    for i in range(4):
...
class RetinaNetHead(nn.Module):
    ...
    def __init__(self: Any, in_channels: Any, num_anchors: Any, num_classes: Any, norm_layer: Optional[Callable[..., nn.Module]]=None) -> object:
        super().__init__()
    ...
    def compute_loss(self: Any, targets: Any, head_outputs: Any, anchors: Any, matched_idxs: Any) -> object:
...
class RetinaNetClassificationHead(nn.Module):
    ...
    def __init__(self: Any, in_channels: Any, num_anchors: Any, num_classes: Any, prior_probability: Any=0.01, norm_layer: Optional[Callable[..., nn.Module]]=None) -> object:
        super().__init__()
        conv = []
        for _ in range(4):
    ...
    def compute_loss(self: Any, targets: Any, head_outputs: Any, matched_idxs: Any) -> object:
        losses = []
...
class RetinaNetRegressionHead(nn.Module):
    ...
    def __init__(self: Any, in_channels: Any, num_anchors: Any, norm_layer: Optional[Callable[..., nn.Module]]=None) -> object:
        super().__init__()
        conv = []
        for _ in range(4):
            conv.append(misc_nn_ops.Conv2dNormActivation(in_channels, in_channels, norm_layer=norm_layer))
...
class RetinaNet(nn.Module):
    ...
    def __init__(self: Any, backbone: Any, num_classes: Any, min_size: Any=800, max_size: Any=1333, image_mean: Any=None, image_std: Any=None, anchor_generator: Any=None, head: Any=None, proposal_matcher: Any=None, score_thresh: Any=0.05, nms_thresh: Any=0.5, detections_per_img: Any=300, fg_iou_thresh: Any=0.5, bg_iou_thresh: Any=0.4, topk_candidates: Any=1000, **kwargs: Any) -> object:
        super().__init__()
    ...
    def compute_loss(self: Any, targets: Any, head_outputs: Any, anchors: Any) -> object:
        matched_idxs = []
    ...
    def postprocess_detections(self: Any, head_outputs: Any, anchors: Any, image_shapes: Any) -> object:
    ...
    def forward(self: Any, images: Any, targets: Any=None) -> object:
        ...
        if torch.jit.is_scripting():
            if not self._has_warned:
                __jac_log_emit__(_gm_log_slot_0, ('RetinaNet always returns a (Losses, Detections) tuple in scripting',), {})
