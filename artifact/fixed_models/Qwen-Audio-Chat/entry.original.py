...
if _dump:
    ...
    # [Defer] emits TWO forms: __jac_log_emit__ for logger calls and
    # __jac_se_emit__ for warnings.warn. Searching only the first silently
    # discards any file whose only rewrite is a warnings.warn.
    _marks = ("__gm_cond_", "__jac_log_emit__", "__jac_se_emit__",
              "__jac_tensor_eq_assert__")
    ...
    for _path, _mod in _hub.items():
        ...
        try:
            ...
            print('GMDUMP_UNPARSE_FAIL ' + _os.path.basename(str(_path))
