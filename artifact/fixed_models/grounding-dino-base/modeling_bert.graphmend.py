...
def load_tf_weights_in_bert(model: Any, config: Any, tf_checkpoint_path: Any) -> object:
...
class BertEmbeddings(nn.Module):
    ...
    def forward(self: Any, input_ids: Optional[torch.LongTensor]=None, token_type_ids: Optional[torch.LongTensor]=None, position_ids: Optional[torch.LongTensor]=None, inputs_embeds: Optional[torch.FloatTensor]=None, past_key_values_length: int=0) -> torch.Tensor:
...
class BertSelfAttention(nn.Module):
    ...
    def __init__(self: Any, config: Any, position_embedding_type: Any=None) -> object:
        super().__init__()
...
class BertSdpaSelfAttention(BertSelfAttention):
    ...
    def forward(self: Any, hidden_states: torch.Tensor, attention_mask: Optional[torch.Tensor]=None, head_mask: Optional[torch.FloatTensor]=None, encoder_hidden_states: Optional[torch.FloatTensor]=None, encoder_attention_mask: Optional[torch.FloatTensor]=None, past_key_value: Optional[Tuple[Tuple[torch.FloatTensor]]]=None, output_attentions: Optional[bool]=False) -> Tuple[torch.Tensor]:
        if self.position_embedding_type != 'absolute' or output_attentions or head_mask is not None:
            __jac_log_emit__(_gm_log_slot_0, ('BertSdpaSelfAttention is used but `torch.nn.functional.scaled_dot_product_attention` does not support "\n                "non-absolute `position_embedding_type` or `output_attentions=True` or `head_mask`. Falling back to "\n                "the manual attention implementation, but specifying the manual implementation will be required from "\n                "Transformers version v5.0.0 onwards. This warning can be removed using the argument "\n                \'`attn_implementation="eager"` when loading the model.',), {})
    ...
    def forward(self: Any, hidden_states: torch.Tensor, attention_mask: Optional[torch.FloatTensor]=None, head_mask: Optional[torch.FloatTensor]=None, encoder_hidden_states: Optional[torch.FloatTensor]=None, encoder_attention_mask: Optional[torch.FloatTensor]=None, past_key_value: Optional[Tuple[Tuple[torch.FloatTensor]]]=None, output_attentions: Optional[bool]=False) -> Tuple[torch.Tensor]:
        ...
        if self.is_decoder and encoder_hidden_states is not None:
            if not hasattr(self, 'crossattention'):
                raise ValueError(f'If `encoder_hidden_states` are passed, {self} has to be instantiated with cross-attention layers"\n                    " by setting `config.add_cross_attention=True`"')
...
class BertOnlyMLMHead(nn.Module):
    ...
    def forward(self: Any, sequence_output: torch.Tensor) -> torch.Tensor:
...
class BertPreTrainingHeads(nn.Module):
    ...
    def forward(self: Any, sequence_output: Any, pooled_output: Any) -> object:
        prediction_scores = self.predictions(sequence_output)
        seq_relationship_score = self.seq_relationship(pooled_output)
...
class BertLMHeadModel(BertPreTrainedModel, GenerationMixin):
    ...
    @auto_docstring
    def forward(self: Any, input_ids: Optional[torch.Tensor]=None, attention_mask: Optional[torch.Tensor]=None, token_type_ids: Optional[torch.Tensor]=None, position_ids: Optional[torch.Tensor]=None, head_mask: Optional[torch.Tensor]=None, inputs_embeds: Optional[torch.Tensor]=None, encoder_hidden_states: Optional[torch.Tensor]=None, encoder_attention_mask: Optional[torch.Tensor]=None, labels: Optional[torch.Tensor]=None, past_key_values: Optional[List[torch.Tensor]]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None, **loss_kwargs: Any) -> Union[Tuple[torch.Tensor], CausalLMOutputWithCrossAttentions]:
        '''r"""
        labels (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
...
class BertForMaskedLM(BertPreTrainedModel):
    ...
    def prepare_inputs_for_generation(self: Any, input_ids: Any, attention_mask: Any=None, **model_kwargs: Any) -> object:
...
class BertForNextSentencePrediction(BertPreTrainedModel):
    ...
    def forward(self: Any, input_ids: Optional[torch.Tensor]=None, attention_mask: Optional[torch.Tensor]=None, token_type_ids: Optional[torch.Tensor]=None, position_ids: Optional[torch.Tensor]=None, head_mask: Optional[torch.Tensor]=None, inputs_embeds: Optional[torch.Tensor]=None, labels: Optional[torch.Tensor]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None, **kwargs: Any) -> Union[Tuple[torch.Tensor], NextSentencePredictorOutput]:
        ...
        if 'next_sentence_label' in kwargs:
            __jac_log_emit__(_gm_log_slot_2, ('The `next_sentence_label` argument is deprecated and will be removed in a future version, use"\n                " `labels` instead.', FutureWarning), {})
...
__all__ = ['BertForMaskedLM', 'BertForMultipleChoice', 'BertForNextSentencePrediction', 'BertForPreTraining', 'BertForQuestionAnswering', 'BertForSequenceClassification', 'BertForTokenClassification', 'BertLayer', 'BertLMHeadModel', 'BertModel', 'BertPreTrainedModel', 'load_tf_weights_in_bert']