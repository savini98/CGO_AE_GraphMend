...
from jaclang.lib.jaclib import __jac_log_emit__, __jac_log_register__, destroy
...
from transformers.utils import ModelOutput, add_start_docstrings, add_start_docstrings_to_model_forward, is_flash_attn_2_available, logging, replace_return_docstrings, is_flash_attn_2_available, is_flash_attn_greater_or_equal_2_10
...
from transformers.modeling_attn_mask_utils import _prepare_4d_attention_mask, _prepare_4d_attention_mask_for_sdpa, _prepare_4d_causal_attention_mask, _prepare_4d_causal_attention_mask_for_sdpa
...
class LearnedAbsolutePositionEmbedding2D(nn.Module):
    ...
    def __init__(self: Any, embedding_dim: Any=256, num_pos: Any=50) -> object:
        super().__init__()
        self.row_embeddings = nn.Embedding(num_pos, embedding_dim // 2)
        self.column_embeddings = nn.Embedding(num_pos, embedding_dim - embedding_dim // 2)

    def forward(self: Any, pixel_values: Any) -> object:
        """
...
class PositionalEmbeddingCosine1D(nn.Module):
    ...
    def __init__(self: Any, embed_dim: int=512, max_seq_len: int=1024) -> None:
        super().__init__()
    ...
    def forward(self: Any, seq_embeds: torch.Tensor) -> torch.Tensor:
        """
        Args:
...
class LearnedAbsolutePositionEmbedding1D(nn.Module):
    ...
    def __init__(self: Any, embedding_dim: int=512, num_pos: int=1024) -> None:
        super().__init__()
...
class MySequential(nn.Sequential):
    ...
    def forward(self: Any, *inputs: Any) -> object:
...
class PreNorm(nn.Module):
    ...
    def __init__(self: Any, norm: Any, fn: Any, drop_path: Any=None) -> object:
        super().__init__()
        self.norm = norm
        self.fn = fn
        self.drop_path = drop_path

    def forward(self: Any, x: Any, *args: Any, **kwargs: Any) -> object:
        shortcut = x
        if self.norm != None:
...
class Mlp(nn.Module):
    ...
    def __init__(self: Any, in_features: Any, hidden_features: Any=None, out_features: Any=None, act_layer: Any=nn.GELU) -> object:
        super().__init__()
    ...
    def forward(self: Any, x: Any, size: Any) -> object:
        return (self.net(x), size)

class DepthWiseConv2d(nn.Module):

    def __init__(self: Any, dim_in: Any, kernel_size: Any, padding: Any, stride: Any, bias: Any=True) -> object:
        super().__init__()
...
class ConvEmbed(nn.Module):
    ...
    def __init__(self: Any, patch_size: Any=7, in_chans: Any=3, embed_dim: Any=64, stride: Any=4, padding: Any=2, norm_layer: Any=None, pre_norm: Any=True) -> object:
        super().__init__()
...
class ChannelAttention(nn.Module):
    ...
    def __init__(self: Any, dim: Any, groups: Any=8, qkv_bias: Any=True) -> object:
        super().__init__()
        self.groups = groups
...
class ChannelBlock(nn.Module):
    ...
    def __init__(self: Any, dim: Any, groups: Any, mlp_ratio: Any=4.0, qkv_bias: Any=True, drop_path_rate: Any=0.0, act_layer: Any=nn.GELU, norm_layer: Any=nn.LayerNorm, conv_at_attn: Any=True, conv_at_ffn: Any=True) -> object:
        super().__init__()
        ...
        self.ffn = PreNorm(norm_layer(dim), Mlp(in_features=dim, hidden_features=int(dim * mlp_ratio), act_layer=act_layer), drop_path)
...
def window_partition(x: Any, window_size: int) -> object:
    B, H, W, C = x.shape
    x = x.view(B, H // window_size, window_size, W // window_size, window_size, C)
    windows = x.permute(0, 1, 3, 2, 4, 5).contiguous().view(-1, window_size, window_size, C)
    return windows

def window_reverse(windows: Any, batch_size: int, window_size: int, H: int, W: int) -> object:
    B = batch_size
...
class WindowAttention(nn.Module):
    ...
    def __init__(self: Any, dim: Any, num_heads: Any, window_size: Any, qkv_bias: Any=True) -> object:
        super().__init__()
        self.dim = dim
...
class SpatialBlock(nn.Module):
    ...
    def __init__(self: Any, dim: Any, num_heads: Any, window_size: Any, mlp_ratio: Any=4.0, qkv_bias: Any=True, drop_path_rate: Any=0.0, act_layer: Any=nn.GELU, norm_layer: Any=nn.LayerNorm, conv_at_attn: Any=True, conv_at_ffn: Any=True) -> object:
        super().__init__()
        drop_path = DropPath(drop_path_rate) if drop_path_rate > 0.0 else nn.Identity()
        self.conv1 = PreNorm(None, DepthWiseConv2d(dim, 3, 1, 1)) if conv_at_attn else None
        self.window_attn = PreNorm(norm_layer(dim), WindowAttention(dim, num_heads, window_size, qkv_bias=qkv_bias), drop_path)
        self.conv2 = PreNorm(None, DepthWiseConv2d(dim, 3, 1, 1)) if conv_at_ffn else None
        self.ffn = PreNorm(norm_layer(dim), Mlp(in_features=dim, hidden_features=int(dim * mlp_ratio), act_layer=act_layer), drop_path)
...
class DaViT(nn.Module):
    ...
    def __init__(self: Any, in_chans: Any=3, num_classes: Any=1000, depths: Any=(1, 1, 3, 1), patch_size: Any=(7, 2, 2, 2), patch_stride: Any=(4, 2, 2, 2), patch_padding: Any=(3, 0, 0, 0), patch_prenorm: Any=(False, False, False, False), embed_dims: Any=(64, 128, 192, 256), num_heads: Any=(3, 6, 12, 24), num_groups: Any=(3, 6, 12, 24), window_size: Any=7, mlp_ratio: Any=4.0, qkv_bias: Any=True, drop_path_rate: Any=0.1, norm_layer: Any=nn.LayerNorm, enable_checkpoint: Any=False, conv_at_attn: Any=True, conv_at_ffn: Any=True) -> object:
        super().__init__()
    ...
    @property
    def dim_out(self: Any) -> object:
        return self.embed_dims[-1]

    def forward_features_unpool(self: Any, x: Any) -> object:
        """
    ...
    def forward_features(self: Any, x: Any) -> object:
    ...
    def forward(self: Any, x: Any) -> object:
        x = self.forward_features(x)
        x = self.head(x)
        return x

    @classmethod
    def from_config(cls: Any, config: Any) -> object:
...
def _get_unpad_data(attention_mask: Any) -> object:
...
def shift_tokens_right(input_ids: torch.Tensor, pad_token_id: int, decoder_start_token_id: int) -> object:
    """
...
class Florence2LearnedPositionalEmbedding(nn.Embedding):
    ...
    def forward(self: Any, input_ids: torch.Tensor, past_key_values_length: int=0) -> object:
...
class Florence2Attention(nn.Module):
    ...
    def __init__(self: Any, embed_dim: int, num_heads: int, dropout: float=0.0, is_decoder: bool=False, bias: bool=True, is_causal: bool=False, config: Optional[Florence2LanguageConfig]=None) -> object:
        super().__init__()
        self.embed_dim = embed_dim
        self.num_heads = num_heads
    ...
    def _shape(self: Any, tensor: torch.Tensor, seq_len: int, bsz: int) -> object:
...
class Florence2FlashAttention2(Florence2Attention):
    ...
    def __init__(self: Any, *args: Any, **kwargs: Any) -> object:
        super().__init__(*args, **kwargs)
        self._flash_attn_uses_top_left_mask = not is_flash_attn_greater_or_equal_2_10()

    def _reshape(self: Any, tensor: torch.Tensor, seq_len: int, bsz: int) -> object:
    ...
    def forward(self: Any, hidden_states: torch.Tensor, key_value_states: Optional[torch.Tensor]=None, past_key_value: Optional[Tuple[torch.Tensor]]=None, attention_mask: Optional[torch.Tensor]=None, layer_head_mask: Optional[torch.Tensor]=None, output_attentions: bool=False) -> Tuple[torch.Tensor, Optional[torch.Tensor], Optional[Tuple[torch.Tensor]]]:
        ...
        if input_dtype == torch.float32:
            ...
            __jac_log_emit__(_gm_log_slot_0, (f'The input hidden states seems to be silently casted in float32, this might be related to"\n                f" the fact you have upcasted embedding or layer norm layers in float32. We will cast back the input in"\n                f" {target_dtype}.',), {})
    ...
    def _flash_attention_forward(self: Any, query_states: Any, key_states: Any, value_states: Any, attention_mask: Any, query_length: Any, dropout: Any=0.0, softmax_scale: Any=None) -> object:
        """
    ...
    def _upad_input(self: Any, query_layer: Any, key_layer: Any, value_layer: Any, attention_mask: Any, query_length: Any) -> object:
...
class Florence2SdpaAttention(Florence2Attention):
    ...
    def forward(self: Any, hidden_states: torch.Tensor, key_value_states: Optional[torch.Tensor]=None, past_key_value: Optional[Tuple[torch.Tensor]]=None, attention_mask: Optional[torch.Tensor]=None, layer_head_mask: Optional[torch.Tensor]=None, output_attentions: bool=False) -> Tuple[torch.Tensor, Optional[torch.Tensor], Optional[Tuple[torch.Tensor]]]:
        ...
        if output_attentions or layer_head_mask is not None:
            __jac_log_emit__(_gm_log_slot_1, ('Florence2Model is using Florence2SdpaAttention, but `torch.nn.functional.scaled_dot_product_attention` does not support `output_attentions=True` or `layer_head_mask` not None. Falling back to the manual attention"\n                \' implementation, but specifying the manual implementation will be required from Transformers version v5.0.0 onwards. This warning can be removed using the argument `attn_implementation="eager"` when loading the model.',), {})
...
FLORENCE2_ATTENTION_CLASSES = {'eager': Florence2Attention, 'sdpa': Florence2SdpaAttention, 'flash_attention_2': Florence2FlashAttention2}

class Florence2EncoderLayer(nn.Module):

    def __init__(self: Any, config: Florence2LanguageConfig) -> object:
        super().__init__()
        self.embed_dim = config.d_model
        self.self_attn = FLORENCE2_ATTENTION_CLASSES[config._attn_implementation](embed_dim=self.embed_dim, num_heads=config.encoder_attention_heads, dropout=config.attention_dropout, config=config)
    ...
    def forward(self: Any, hidden_states: torch.FloatTensor, attention_mask: torch.FloatTensor, layer_head_mask: torch.FloatTensor, output_attentions: Optional[bool]=False) -> Tuple[torch.FloatTensor, Optional[torch.FloatTensor]]:
        """
        Args:
        ...
        if torch.is_grad_enabled():
            ...
            __gm_cond_0 = torch.logical_or(torch.isinf(hidden_states).any(), torch.isnan(hidden_states).any())
            clamp_value = torch.finfo(hidden_states.dtype).max - 1000
            hidden_states = torch.where(__gm_cond_0, torch.clamp(hidden_states, min=-clamp_value, max=clamp_value), hidden_states)
...
class Florence2DecoderLayer(nn.Module):
    ...
    def __init__(self: Any, config: Florence2LanguageConfig) -> object:
        super().__init__()
        self.embed_dim = config.d_model
        self.self_attn = FLORENCE2_ATTENTION_CLASSES[config._attn_implementation](embed_dim=self.embed_dim, num_heads=config.decoder_attention_heads, dropout=config.attention_dropout, is_decoder=True, is_causal=True, config=config)
        self.dropout = config.dropout
        self.activation_fn = ACT2FN[config.activation_function]
        self.activation_dropout = config.activation_dropout
        self.self_attn_layer_norm = nn.LayerNorm(self.embed_dim)
        self.encoder_attn = FLORENCE2_ATTENTION_CLASSES[config._attn_implementation](self.embed_dim, config.decoder_attention_heads, dropout=config.attention_dropout, is_decoder=True, config=config)
...
class Florence2LanguagePreTrainedModel(PreTrainedModel):
    ...
    _no_split_modules = ['Florence2EncoderLayer', 'Florence2DecoderLayer']
    ...
    @property
    def dummy_inputs(self: Any) -> object:
...
class Florence2Encoder(Florence2LanguagePreTrainedModel):
    ...
    def __init__(self: Any, config: Florence2LanguageConfig, embed_tokens: Optional[nn.Embedding]=None) -> object:
        ...
        self.embed_tokens = Florence2ScaledWordEmbedding(config.vocab_size, embed_dim, self.padding_idx, embed_scale=embed_scale)
        if embed_tokens is not None:
            self.embed_tokens.weight = embed_tokens.weight
        self.embed_positions = Florence2LearnedPositionalEmbedding(config.max_position_embeddings, embed_dim)
    ...
    def forward(self: Any, input_ids: torch.LongTensor=None, attention_mask: Optional[torch.Tensor]=None, head_mask: Optional[torch.Tensor]=None, inputs_embeds: Optional[torch.FloatTensor]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None) -> Union[Tuple, BaseModelOutput]:
        ...
        if head_mask is not None:
            if head_mask.size()[0] != len(self.layers):
                raise ValueError(f'The head_mask should be specified for {len(self.layers)} layers, but it is for"\n                    f" {head_mask.size()[0]}.')
...
class Florence2Decoder(Florence2LanguagePreTrainedModel):
    ...
    def __init__(self: Any, config: Florence2LanguageConfig, embed_tokens: Optional[nn.Embedding]=None) -> object:
        ...
        self.embed_tokens = Florence2ScaledWordEmbedding(config.vocab_size, config.d_model, self.padding_idx, embed_scale=embed_scale)
        if embed_tokens is not None:
            self.embed_tokens.weight = embed_tokens.weight
    ...
    def forward(self: Any, input_ids: torch.LongTensor=None, attention_mask: Optional[torch.Tensor]=None, encoder_hidden_states: Optional[torch.FloatTensor]=None, encoder_attention_mask: Optional[torch.LongTensor]=None, head_mask: Optional[torch.Tensor]=None, cross_attn_head_mask: Optional[torch.Tensor]=None, past_key_values: Optional[List[torch.FloatTensor]]=None, inputs_embeds: Optional[torch.FloatTensor]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None) -> Union[Tuple, BaseModelOutputWithPastAndCrossAttentions]:
        ...
        if self.gradient_checkpointing and self.training:
            if use_cache:
                __jac_log_emit__(_gm_log_slot_2, ('`use_cache=True` is incompatible with gradient checkpointing. Setting `use_cache=False`...',), {})
                use_cache = False
        ...
        for attn_mask, mask_name in zip([head_mask, cross_attn_head_mask], ['head_mask', 'cross_attn_head_mask']):
            if attn_mask is not None:
                if attn_mask.size()[0] != len(self.layers):
                    raise ValueError(f'The `{mask_name}` should be specified for {len(self.layers)} layers, but it is for"\n                        f" {head_mask.size()[0]}.')
...
class Florence2LanguageModel(Florence2LanguagePreTrainedModel):
    ...
    def get_encoder(self: Any) -> object:
        return self.encoder

    def get_decoder(self: Any) -> object:
        return self.decoder
    ...
    def forward(self: Any, input_ids: torch.LongTensor=None, attention_mask: Optional[torch.Tensor]=None, decoder_input_ids: Optional[torch.LongTensor]=None, decoder_attention_mask: Optional[torch.LongTensor]=None, head_mask: Optional[torch.Tensor]=None, decoder_head_mask: Optional[torch.Tensor]=None, cross_attn_head_mask: Optional[torch.Tensor]=None, encoder_outputs: Optional[List[torch.FloatTensor]]=None, past_key_values: Optional[List[torch.FloatTensor]]=None, inputs_embeds: Optional[torch.FloatTensor]=None, decoder_inputs_embeds: Optional[torch.FloatTensor]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None) -> Union[Tuple, Seq2SeqModelOutput]:
        if decoder_input_ids is None and decoder_inputs_embeds is None:
            if input_ids is None:
                raise ValueError('If no `decoder_input_ids` or `decoder_inputs_embeds` are "\n                    "passed, `input_ids` cannot be `None`. Please pass either "\n                    "`input_ids` or `decoder_input_ids` or `decoder_inputs_embeds`.')
...
class Florence2LanguageForConditionalGeneration(Florence2LanguagePreTrainedModel, GenerationMixin):
    ...
    def resize_token_embeddings(self: Any, new_num_tokens: int, pad_to_multiple_of: Optional[int]=None, **kwargs: Any) -> nn.Embedding:
        new_embeddings = super().resize_token_embeddings(new_num_tokens, pad_to_multiple_of, **kwargs)
        self._resize_final_logits_bias(new_embeddings.weight.shape[0])
        return new_embeddings

    def _resize_final_logits_bias(self: Any, new_num_tokens: int) -> None:
    ...
    def forward(self: Any, input_ids: torch.LongTensor=None, attention_mask: Optional[torch.Tensor]=None, decoder_input_ids: Optional[torch.LongTensor]=None, decoder_attention_mask: Optional[torch.LongTensor]=None, head_mask: Optional[torch.Tensor]=None, decoder_head_mask: Optional[torch.Tensor]=None, cross_attn_head_mask: Optional[torch.Tensor]=None, encoder_outputs: Optional[List[torch.FloatTensor]]=None, past_key_values: Optional[List[torch.FloatTensor]]=None, inputs_embeds: Optional[torch.FloatTensor]=None, decoder_inputs_embeds: Optional[torch.FloatTensor]=None, labels: Optional[torch.LongTensor]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None) -> Union[Tuple, Seq2SeqLMOutput]:
        ...
        if labels is not None:
            if use_cache:
                __jac_log_emit__(_gm_log_slot_3, ('The `use_cache` argument is changed to `False` since `labels` is provided.',), {})
            use_cache = False
            if decoder_input_ids is None and decoder_inputs_embeds is None:
    ...
    def prepare_inputs_for_generation(self: Any, decoder_input_ids: Any, past_key_values: Any=None, attention_mask: Any=None, decoder_attention_mask: Any=None, head_mask: Any=None, decoder_head_mask: Any=None, cross_attn_head_mask: Any=None, use_cache: Any=None, encoder_outputs: Any=None, **kwargs: Any) -> object:
    ...
    def prepare_decoder_input_ids_from_labels(self: Any, labels: torch.Tensor) -> object:
...
_gm_log_slot_3 = __jac_log_register__(logger.warning)
...
@add_start_docstrings('The bare Florence-2 Model outputting raw hidden-states without any specific head on top.', FLORENCE2_START_DOCSTRING)
class Florence2PreTrainedModel(PreTrainedModel):
    ...
    @property
    def _supports_flash_attn_2(self: Any) -> object:
        """
...
@add_start_docstrings('The FLORENCE2 vision model with projection layer', FLORENCE2_START_DOCSTRING)
class Florence2VisionModelWithProjection(Florence2PreTrainedModel):
    ...
    def _build_image_projection_layers(self: Any, config: Any) -> object:
...
@add_start_docstrings('The FLORENCE2 model which consists of a vision backbone and a language model.', FLORENCE2_START_DOCSTRING)
class Florence2ForConditionalGeneration(Florence2PreTrainedModel):
    ...
    def __init__(self: Any, config: Florence2Config) -> object:
        super().__init__(config)
        assert config.vision_config.model_type == 'davit', 'only DaViT is supported for now'
        self.vision_tower = DaViT.from_config(config=config.vision_config)
        destroy([self.vision_tower.head])
        del self.vision_tower.head
        destroy([self.vision_tower.norms])
    ...
    def resize_token_embeddings(self: Any, new_num_tokens: Optional[int]=None, pad_to_multiple_of: Any=None, **kwargs: Any) -> nn.Embedding:
    ...
    def _encode_image(self: Any, pixel_values: Any) -> object:
        if len(pixel_values.shape) == 4:
            batch_size, C, H, W = pixel_values.shape
            T = 1
            x = self.vision_tower.forward_features_unpool(pixel_values)
    ...
    def _merge_input_ids_with_image_features(self: Any, image_features: Any, inputs_embeds: Any) -> object:
    ...
    def forward(self: Any, input_ids: torch.LongTensor=None, pixel_values: torch.FloatTensor=None, attention_mask: Optional[torch.Tensor]=None, decoder_input_ids: Optional[torch.LongTensor]=None, decoder_attention_mask: Optional[torch.LongTensor]=None, head_mask: Optional[torch.Tensor]=None, decoder_head_mask: Optional[torch.Tensor]=None, cross_attn_head_mask: Optional[torch.Tensor]=None, encoder_outputs: Optional[List[torch.FloatTensor]]=None, past_key_values: Optional[List[torch.FloatTensor]]=None, inputs_embeds: Optional[torch.FloatTensor]=None, decoder_inputs_embeds: Optional[torch.FloatTensor]=None, labels: Optional[torch.LongTensor]=None, use_cache: Optional[bool]=None, output_attentions: Optional[bool]=None, output_hidden_states: Optional[bool]=None, return_dict: Optional[bool]=None) -> Union[Tuple, Florence2Seq2SeqLMOutput]:
        '''r"""
        Args:
            labels (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
                Labels for computing the masked language modeling loss. Indices should either be in `[0, ...,
        ...
        return Florence2Seq2SeqLMOutput(loss=loss, logits=logits, past_key_values=outputs.past_key_values, decoder_hidden_states=outputs.decoder_hidden_states, decoder_attentions=outputs.decoder_attentions, cross_attentions=outputs.cross_attentions, encoder_last_hidden_state=outputs.encoder_last_hidden_state, encoder_hidden_states=outputs.encoder_hidden_states, encoder_attentions=outputs.encoder_attentions, image_hidden_states=image_features)

    def generate(self: Any, input_ids: Any, inputs_embeds: Any=None, pixel_values: Any=None, **kwargs: Any) -> object:
        if inputs_embeds is None:
            if input_ids is not None:
                inputs_embeds = self.get_input_embeddings()(input_ids)
            if pixel_values is not None:
    ...
    def prepare_inputs_for_generation(self: Any, decoder_input_ids: Any, past_key_values: Any=None, attention_mask: Any=None, pixel_values: Any=None, decoder_attention_mask: Any=None, head_mask: Any=None, decoder_head_mask: Any=None, cross_attn_head_mask: Any=None, use_cache: Any=None, encoder_outputs: Any=None, **kwargs: Any) -> object:
        if past_key_values is not None:
            past_length = past_key_values[0][0].shape[2]
            if decoder_input_ids.shape[1] > past_length:
                remove_prefix_length = past_length
    ...
    def _reorder_cache(self: Any, *args: Any, **kwargs: Any) -> object:
